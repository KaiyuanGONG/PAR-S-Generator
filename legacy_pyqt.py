"""Historical PyQt compatibility entrypoint; not a Windows v1 production path."""
...
def main() -> None:
    ...
    app.setApplicationName("PAR-S Generator legacy PyQt")
    app.setApplicationVersion("0.5.0-legacy")
